...
=== Retrieve our current public IP address

We need this information in order to authorize connection to the database from `port 3306` from our work or home.
So we make a note of it:
