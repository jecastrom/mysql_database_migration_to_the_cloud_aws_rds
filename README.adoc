= Mini Project - Automating MySQL Database migration to the cloud (AWS RDS)
...
:toc:
:toc-title: In this mini-project I will be migrating a MySQL on-premises schema to a cloud MySQL instance and automate the process.
:toc-placement!:
:toclevels: 5
ifdef::env-github[]
:sectnums:
