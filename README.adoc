...
I will be using the mysql shell Instance Dump Utility and the mysql shell Dump Loading Utility to load the data to the AWS RDS instance. I will be using the AWS CLI commands only when working with AWS and MzSQL.
