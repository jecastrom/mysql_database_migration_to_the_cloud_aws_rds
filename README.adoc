...
In this project I wanted to learn how to make an migration of a MySQL on-premises database to the cloud, specifically to a  AWS RDS instance. Lastly I wanted to automate this process from bigining to end so it can be done faster and with the least amount of downtime.
