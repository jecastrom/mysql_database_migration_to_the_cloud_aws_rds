= Mini Project -             Database migration to the cloud using CLIs
...
== Migrate the Sakila database to a cloud provider using the MySql and the cloud provider CLI.

I am going to migrate the sakila database to AWS RDS (Relational Database Service).
